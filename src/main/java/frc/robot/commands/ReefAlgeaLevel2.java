...
public class ReefAlgeaLevel2 extends SequentialCommandGroup {
  public ReefAlgeaLevel2(Elevator elevator, Wrist wrist, Intake intake) {
    addCommands(
        new ParallelCommandGroup(
            new InstantCommand(() -> elevator.goToAlgae2(), elevator),
            new InstantCommand(() -> wrist.goToAlgae2(), wrist)),
