...
public class ElevatorSysIdQuasistaticForward extends Command {
    private final Command m_generatedSysIdCommand;
    private final Elevator m_elevator;

    public ElevatorSysIdQuasistaticForward(Elevator elevator) {
        ...
        SysIdRoutine sysIdRoutine = new SysIdRoutine(
                ...
                // Direction is specified when creating the specific test command
        );
        // Generate the specific test command
        m_generatedSysIdCommand = sysIdRoutine.quasistatic(SysIdRoutine.Direction.kForward);
