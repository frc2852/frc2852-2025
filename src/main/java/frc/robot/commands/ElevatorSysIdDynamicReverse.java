...
public class ElevatorSysIdDynamicReverse extends Command {
    private final Command m_generatedSysIdCommand;
    private final Elevator m_elevator;

    public ElevatorSysIdDynamicReverse(Elevator elevator) {
        ...
        m_generatedSysIdCommand = sysIdRoutine.dynamic(SysIdRoutine.Direction.kReverse);
