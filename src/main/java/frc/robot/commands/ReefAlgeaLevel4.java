  ...
  public ReefAlgeaLevel4(Elevator elevator, Wrist wrist, Intake intake) {
    addCommands(
        new ParallelCommandGroup(
            new InstantCommand(() -> elevator.goToPosition(MotorSetPoint.ELEVATOR_ALGEA_LEVEL_4), elevator),
            new InstantCommand(() -> wrist.goToPosition(MotorSetPoint.WRIST_ALGEA_LEVEL_4), wrist)),
